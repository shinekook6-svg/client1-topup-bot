...
bot.command("contact", async (ctx) => {
  const keyboard = new InlineKeyboard()
    .url("👨‍💻 Chat with Admin", "https://t.me/Ouriky_2k9")
    .row()
    .text("🏠 Back to Home", "back_home");
...
bot.command("proof", async (ctx) => {
  const keyboard = new InlineKeyboard()
    .url("✅ Go to Proof Channel", "https://t.me/Ouriky_Sellproof")
    .row()
    .text("🏠 Back to Home", "back_home");
...
await ctx.api.sendMessage(8356830666, 
